                  ...
                  <form action = "{{ route('fakultas.update', $fakultas->id) }}" method="POST">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_dekan" value="{{ old('nama_dekan') ?: $fakultas->nama_dekan }}"> 
                      </div>
                      <div class="mb-3">
                        <label for="nama_wadek" class="form-label">Nama Wakil Dekan</label>
                        <input type="text" class="form-control" name="nama_wadek" value="{{ old('nama_wadek') ?: $fakultas->nama_wadek }}"> 
                      </div>
                    <!--end::Body-->
                    <!--begin::Footer-->
